      ...
      <div class="flex flex-wrap gap-2 items-center">
        ...
        <div class="relative" ref="nodeFilterRef" data-testid="node-filter">
          <button
            ...
            <span v-else-if="filters.node_ids.length === 1"
              class="text-blue-600 dark:text-blue-400 font-medium flex-1 text-left text-xs min-w-0"
              data-testid="node-filter-summary"
            >
              <PathLabel
                :segments="[filters.node_ids[0].tree_name, ...(filters.node_ids[0].path && filters.node_ids[0].path.length ? filters.node_ids[0].path : [filters.node_ids[0].node_name])]"
              />
            </span>
