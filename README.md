...
- **Proxmox LXC** (`/etc/pve/lxc/<CTID>.conf`) — both lines are required, the mount entry alone is not sufficient (see `docs/AGENT_REFERENCE.md`, "owserver (1-Wire) in the LXC template"):
  ```
